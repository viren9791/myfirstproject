  ...
  <div class="pagination">
    <?php 
      ...
      echo jq_link_to_remote(
          ...
          array(
              'update' => 'listing', 
              'url' => '@AttributeList?page='.$oPager->getPreviousPage()
          )
      );
      ...
      echo jq_link_to_remote(
          ...
          array(
              'update' => 'listing', 
              'url' => '@AttributeList?page='.$oPager->getNextPage()
          )
      );
      ...
      echo jq_link_to_remote(
          ...
          array(
              'update' => 'listing', 
              'url' => '@AttributeList?page='.$oPager->getLastPage()
          )
      );
    ?>
  </div>
