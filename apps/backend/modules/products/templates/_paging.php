  ...
  <div class="pagination">
    <?php 
      ...
      echo jq_link_to_remote(
          ...
          array(
              'update' => 'listing', 
              'url' => '@product_list?page='.$oPager->getPreviousPage()
          )
      );
      ...
      echo jq_link_to_remote(
          ...
          array(
              'update' => 'listing', 
              'url' => '@product_list?page='.$oPager->getNextPage()
          )
      );
      echo jq_link_to_remote(
          ...
          array(
              'update' => 'listing', 
              'url' => '@product_list?page='.$oPager->getLastPage()
          )
      );
    ?>
  </div>
